...
> **Note (2026-06).** "During the Letta migration" framing refers to the Den-native runtime effort; the target runtime is the in-process Den loop. See [Den-Native Runtime](den-native-runtime.md) ([migration plan](../roadmap/DEN_NATIVE_RUNTIME_PLAN.md)).
