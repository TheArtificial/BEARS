...
> **Archived / superseded (2026-06).** There is a single Den execution target per tool, not a Den + Letta Code + Letta capability matrix. Canonical target: [Den runtime](../../architecture/den-runtime.md) ([runtime plan](../DEN_RUNTIME_PLAN.md)).
