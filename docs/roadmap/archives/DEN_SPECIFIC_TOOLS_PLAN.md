...
> **Archived / superseded (2026-06).** Den tools run in-process in the Den loop, not via Den -> Codepool -> Letta Code SDK, and not against Letta Code-native MemFS tools. Canonical target: [Den runtime](../../architecture/den-runtime.md) ([runtime plan](../DEN_RUNTIME_PLAN.md)).
