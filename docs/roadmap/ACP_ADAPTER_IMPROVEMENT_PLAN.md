...
> **Direction changed (2026-06).** Adapter hardening targets Den runtime turn events, not Letta streams / Letta Code SDK / Codepool flows. Canonical target: [Den runtime](../architecture/den-runtime.md) ([runtime plan](DEN_RUNTIME_PLAN.md)).
