...
| **Cabinet** | **Proposed:** Den-governed shared, human-editable knowledge with Mission-scoped policy; research reading/highlights are a separate ingestion client | [`CABINET_IMPLEMENTATION_PLAN.md`](CABINET_IMPLEMENTATION_PLAN.md), [`CABINET_RESEARCH_INGESTION_PLAN.md`](CABINET_RESEARCH_INGESTION_PLAN.md) |
