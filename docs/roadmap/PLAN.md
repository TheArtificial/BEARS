...
| **Capability discovery / Code Mode** | Proposed: replace large static tool/skill prompt rosters with taxonomy-enabled capability discovery, a bounded recently-discovered working set, and Code Mode as an execution option for composed workflows | [`CAPABILITY_DISCOVERY_AND_CODE_MODE_IMPLEMENTATION_PLAN.md`](CAPABILITY_DISCOVERY_AND_CODE_MODE_IMPLEMENTATION_PLAN.md), [ADR-0054](../decisions/adr-0054-capability-discovery-and-code-mode.md) |
