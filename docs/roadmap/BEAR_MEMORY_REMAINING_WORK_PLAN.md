...
| Phase | Work | Status |
|---|---|---|
| **5 — Anchors** | Generalize projection anchors to `core/people/…`, `core/missions/…`; explicit-anchor-only v1 projection | 🟡 path helper + policy landed; projection query/wiring open |
