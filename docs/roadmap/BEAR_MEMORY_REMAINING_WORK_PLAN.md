...
| **Write topology (ADR-0031 amendment)** | Workers already in-process Tokio tasks | Consolidate to one `MemoryStoreManager` per process; CI invariant; CLI guardrails | [MEMORY_WRITE_TOPOLOGY_PLAN.md](MEMORY_WRITE_TOPOLOGY_PLAN.md) |
