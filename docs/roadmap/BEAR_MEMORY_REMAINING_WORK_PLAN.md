...
| **Write topology (ADR-0031 amendment)** | One `MemoryStoreManager` per process threaded through all subsystems (Phase 1, `eaaf897a`) | Constructor-visibility restriction + CI invariant; CLI/deployment guardrails | [MEMORY_WRITE_TOPOLOGY_PLAN.md](MEMORY_WRITE_TOPOLOGY_PLAN.md) |
