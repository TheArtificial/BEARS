...
- [ ] Regenerate and commit [`.sqlx/`](../.sqlx/) after schema/query changes: `./scripts/sqlx.sh migrate run` then `./scripts/sqlx.sh prepare --workspace -- --all-targets` against the migrated database (see [`sqlx-patterns.md`](sqlx-patterns.md)).
