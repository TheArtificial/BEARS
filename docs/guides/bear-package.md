...
See [reflection-run split](../architecture/den-runtime.md#the-reflection-run-split): queue in Postgres, outcomes in SQLite (outcomes ship in the package; queue does not).
