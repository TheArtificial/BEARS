...
1. **Phase 1 scope:** **First-class routines in Den** — DB-backed **schedules**, operator (and where appropriate end-user) **UI** to define and manage them—not “docs-only” or “cron outside Den only.” See [PHASE1_DECISIONS.md](../roadmap/PHASE1_DECISIONS.md) decision **10**.
...
- **Cross-link:** [PLAN.md](../roadmap/PLAN.md) § Routines and scheduled work; [artifacts-garage.md](artifacts-garage.md).

---

## References

- [PLAN.md — Routines and scheduled work (Idea 5)](../roadmap/PLAN.md#routines-and-scheduled-work-phase-1-idea-5)
