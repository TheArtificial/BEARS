...
enum BundledAdapterLocatorError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .missingResource(let checkedPaths):
            ...
            return "The Bears app bundle does not contain a bundled bear-armature executable. The app can fall back to downloading one if configured. Checked:\n\(details)"
        }
    }
}
...
struct BundledAdapterLocator: BundledAdapterLocating {
    ...
    func bundledAdapterExecutableURL() throws -> URL {
        let candidates = [
            resourceBundle.url(forResource: "bear-armature", withExtension: nil),
            resourceBundle.url(forResource: "bear-armature", withExtension: nil, subdirectory: "Adapter"),
            resourceBundle.url(forResource: "bear-armature", withExtension: nil, subdirectory: "Resources/Adapter"),
            resourceBundle.resourceURL?
                .appendingPathComponent("Adapter", isDirectory: true)
                .appendingPathComponent("bear-armature", isDirectory: false),
            resourceBundle.resourceURL?
