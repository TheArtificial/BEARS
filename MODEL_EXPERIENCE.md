...
Loop governance and budgets: [ADR-0050](docs/decisions/adr-0050-runtime-loop-governance-adaptive-budgets-and-progress-checkpoints.md) · [ADR-0047](docs/decisions/adr-0047-context-window-budget-and-token-estimation.md)
