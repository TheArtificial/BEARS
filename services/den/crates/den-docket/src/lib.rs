...
pub use model::{
    ...
    DocketEntryRow, DocketEntryScope, DocketExecutionControl, DocketExecutionLookup,
    DocketExecutionNextAction, DocketExecutionReason, DocketExecutionSessionRow,
    DocketExecutionSessionUpsert, DocketJobCreate, DocketJobCriterionInput, DocketJobCriterionRow,
    ...
    DocketOutcomeDisposition, DocketRunState, DocketRunTrigger, DocketSessionTaskSettlement,
