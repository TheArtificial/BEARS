...
pub use model::{
    ...
    DocketEntryRow, DocketEntryScope, DocketExecutionControl, DocketExecutionGate,
    DocketExecutionLookup, DocketExecutionNextAction, DocketExecutionReason,
    ...
    DocketRunTrigger, DocketSessionTaskSettlement, DocketTaskCreate, DocketTaskDefinitionPatch,
    ...
    DocketValidationError, MutationPolicy, ResultRollupPolicy, RoutingStrategy,
