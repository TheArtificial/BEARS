...
pub fn builtin_den_tool_descriptors() -> Vec<DenToolDescriptor> {
    vec![
        ...
        descriptor(
            ...
            &["docket.job.write"],
            CHAT_AND_PAIR_PROFILES,
            json!({"type":"object","properties":{"job_id":{"type":"string","format":"uuid"},"goal":{"type":"string"},"work_surface_id":{"type":"string","format":"uuid"},"commit_policy":{"enum":["none","per_task","per_job",null]},"clear_commit_policy":{"type":"boolean"},"status":{"enum":["draft","ready","running","blocked","completed","cancelled","archived"]},"visibility":{"enum":["private_to_profile","same_user","bear_visible","handoff_requested"]}},"required":["job_id"],"additionalProperties":false}),
        ),
        descriptor(
            DEN_JOB_EXECUTE,
            "Execute Docket job",
