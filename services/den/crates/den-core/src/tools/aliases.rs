use crate::tools::constants::{
    ...
    DEN_DOCKET_ENTRY_LIST, DEN_ENTITY_BROWSE, DEN_ENTITY_LINK_MEMORY, DEN_ENTITY_MERGE,
    DEN_ENTITY_RESOLVE, DEN_ENTITY_SPLIT, DEN_ENTITY_WRITE_ACCESS_RULE, DEN_ENTITY_WRITE_ANCHOR,
    DEN_JOB_CREATE, DEN_JOB_EVALUATE_CRITERION, DEN_JOB_EXECUTE, DEN_JOB_FIND, DEN_JOB_GET,
    DEN_JOB_LIST, DEN_JOB_UPDATE, DEN_MEMORY_APPLY_CORE_UPDATE,
