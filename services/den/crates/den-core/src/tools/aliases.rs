use crate::tools::constants::{
    DEN_BEAR_ENVIRONMENT, DEN_BEAR_GET_SELF, DEN_BEAR_LIST_MEMBERS, DEN_CABINET_CREATE,
    DEN_CABINET_READ, DEN_CABINET_SEARCH, DEN_CABINET_UPDATE, DEN_CAPABILITIES_LIST_SELF,
    ...
    DEN_JOB_RECONCILE, DEN_JOB_SETTLE_TASK, DEN_JOB_UPDATE, DEN_MEMORY_APPLY_CORE_UPDATE,
    ...
    DEN_PROMPT_MEMORY_UPSERT, DEN_RUNTIME_DIAGNOSTICS_LIST, DEN_RUN_WRITE_RESULT,
    ...
    DEN_TASK_LIST_SYNC, DEN_TASK_REJECT_INTENT, DEN_TASK_SELECT, DEN_TASK_UPDATE,
    DEN_TASK_UPDATE_CURRENT_STATUS, DEN_TASK_WRITE_INTENT, DEN_TOOL_OUTPUT_READ,
