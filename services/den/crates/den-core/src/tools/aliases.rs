use crate::tools::constants::{
    ...
    DEN_MEMORY_LIST_PROPOSALS, DEN_MEMORY_MARK_LIFECYCLE, DEN_MEMORY_ORIENT_WORK_SURFACE, DEN_MEMORY_READ,
    ...
    DEN_TASK_LIST_CHECKOUT, DEN_TASK_LIST_SYNC, DEN_TASK_REJECT_INTENT, DEN_TASK_UPDATE,
