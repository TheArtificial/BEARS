use crate::tools::constants::{
    ...
    DEN_CONVERSATION_SET_TITLE, DEN_CORE_WRITE_RESULT_SUMMARY, DEN_DOCKET_ENTRY_APPEND,
    DEN_DOCKET_ENTRY_LIST, DEN_DOCKET_ENTRY_PROMOTE, DEN_ENTITY_BROWSE, DEN_ENTITY_LINK_MEMORY,
    DEN_ENTITY_MERGE, DEN_ENTITY_RESOLVE, DEN_ENTITY_SPLIT, DEN_ENTITY_WRITE_ACCESS_RULE,
    DEN_ENTITY_WRITE_ANCHOR, DEN_JOB_CREATE, DEN_JOB_EVALUATE_CRITERION, DEN_JOB_EXECUTE,
    DEN_JOB_FIND, DEN_JOB_GET, DEN_JOB_LIST, DEN_JOB_UPDATE, DEN_MEMORY_APPLY_CORE_UPDATE,
    DEN_MEMORY_CREATE_WORK_SURFACE_SCAFFOLD, DEN_MEMORY_LIST_PROPOSALS, DEN_MEMORY_MARK_LIFECYCLE,
    DEN_MEMORY_ORIENT_WORK_SURFACE, DEN_MEMORY_READ, DEN_MEMORY_READ_PROPOSAL,
    DEN_MEMORY_REQUEST_REVIEW, DEN_MEMORY_RESOLVE_PROPOSAL, DEN_MEMORY_SEARCH, DEN_MEMORY_STATUS,
    DEN_MEMORY_TREE, DEN_MEMORY_TREE_LEGACY_PROVIDER, DEN_MEMORY_WRITE_ENTRY,
    ...
    DEN_RUN_WRITE_RESULT, DEN_SITUATION_GET, DEN_SITUATION_GET_LEGACY_PROVIDER,
    DEN_SKILL_APPROVE_PROPOSAL, DEN_SKILL_PROPOSE, DEN_SKILL_REJECT_PROPOSAL,
    DEN_TASK_APPROVE_INTENT, DEN_TASK_CREATE, DEN_TASK_FIND, DEN_TASK_LIST,
    ...
    DEN_TASK_SELECT, DEN_TASK_UPDATE, DEN_TASK_UPDATE_CURRENT_STATUS, DEN_TASK_WRITE_INTENT,
    DEN_TOOL_OUTPUT_READ, DEN_USER_GET_CURRENT, DEN_WEB_FETCH, DEN_WEB_FETCH_LEGACY_PROVIDER,
    DEN_WEB_SEARCH, DEN_WORK_CATALOG, DEN_WORK_DISPATCH, DEN_WORK_PREPARE_RUST_DEPENDENCIES,
