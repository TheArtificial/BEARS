use crate::tools::constants::{
    ...
    DEN_ENTITY_WRITE_ANCHOR, DEN_JOB_ARCHIVE, DEN_JOB_CANCEL, DEN_JOB_CREATE,
    ...
    DEN_SKILL_REJECT_PROPOSAL, DEN_TASK_APPROVE_INTENT, DEN_TASK_CREATE, DEN_TASK_FIND,
    DEN_TASK_LIST, DEN_TASK_LISTS_GET_STATUS, DEN_TASK_LISTS_LIST, DEN_TASK_LISTS_REQUEST_HANDOFF,
