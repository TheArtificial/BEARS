...
fn semantic_turn_completed_uses_direct_gateway_projection_shape() {
    let projected = den_runtime::runtime_bearwire_projection::runtime_semantic_event_to_bearwire_gateway_events(
...
fn untranslated_provider_event_still_requires_seed_path() {
    let projected = den_runtime::runtime_bearwire_projection::runtime_stream_event_to_bearwire_sse(
