...
pub use checkpoints::{
    ...
    CheckpointVisibility, ContextBudgetPressureLevel, ExpectedLoopControlReplayTurn,
    GroundingProbeFinding, GroundingProbeResultInput, GroundingProbeSignalKind, LedgerEvidenceRef,
    LoopControlDecisionKind, LoopControlLedgerInput, LoopControlLedgerRow,
    LoopControlReplayMismatch, LoopControlReplayObservation, LoopControlReplayTurn,
    LoopControlReplayTurnMismatch,
};
pub use context::{
