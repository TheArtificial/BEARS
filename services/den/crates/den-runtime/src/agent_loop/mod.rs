...
pub use checkpoints::{
    ...
    compare_loop_control_replay_turns, context_budget_pressure_action, list_checkpoints_for_run,
    ...
    ContextBudgetPressureLevel, ExpectedLoopControlReplayTurn, GroundingProbeFinding,
    GroundingProbeResultInput, GroundingProbeSignalKind, LedgerEvidenceRef,
    LoopControlDecisionKind, LoopControlLedgerInput, LoopControlLedgerRow, LoopControlReplayCount,
    LoopControlReplayMismatch, LoopControlReplayObservation, LoopControlReplayProfileSummary,
    LoopControlReplayTurn, LoopControlReplayTurnMismatch,
};
pub use context::{
