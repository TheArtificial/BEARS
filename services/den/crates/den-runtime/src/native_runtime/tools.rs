use den_core::{
    config::Config,
    tools::constants::{
        DEN_CABINET_CREATE_PROVIDER, DEN_CABINET_HISTORY_PROVIDER,
    DEN_CABINET_LIFECYCLE_PROVIDER, DEN_CABINET_READ_PROVIDER, DEN_CABINET_SOURCE_LINK_PROVIDER, DEN_CABINET_SEARCH_PROVIDER,
        DEN_CABINET_UPDATE_PROVIDER, DEN_JOB_ARCHIVE_PROVIDER, DEN_JOB_CANCEL_PROVIDER,
        DEN_JOB_CREATE_PROVIDER,
        DEN_JOB_EVALUATE_CRITERION_PROVIDER, DEN_JOB_EXECUTE_PROVIDER, DEN_JOB_GET_PROVIDER,
        DEN_JOB_LIST_PROVIDER, DEN_JOB_RECONCILE_PROVIDER, DEN_JOB_SETTLE_TASK_PROVIDER,
        DEN_JOB_UPDATE_PROVIDER, DEN_TASK_CREATE_PROVIDER, DEN_TASK_LISTS_GET_STATUS_PROVIDER,
        DEN_TASK_LISTS_LIST_PROVIDER, DEN_TASK_LISTS_REQUEST_HANDOFF_PROVIDER,
        DEN_TASK_LISTS_UPDATE_PROVIDER, DEN_TASK_LIST_CHECKOUT_PROVIDER, DEN_TASK_LIST_PROVIDER,
        DEN_TASK_LIST_SYNC_PROVIDER, DEN_TASK_SELECT_PROVIDER,
